...
\end{DoxyParagraph}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md20}{}\doxysection{Prerequisites}\label{md_pages_getstarted_build_and_install_autotoc_md20}
...
\end{DoxyItemize}\hypertarget{md_pages_getstarted_build_and_install_autotoc_md21}{}\doxysection{Pratical steps}\label{md_pages_getstarted_build_and_install_autotoc_md21}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md22}{}\doxysubsection{1. Prep}\label{md_pages_getstarted_build_and_install_autotoc_md22}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md23}{}\doxysubsection{2. Cloning}\label{md_pages_getstarted_build_and_install_autotoc_md23}
...
By default, the above commands will clone the {\itshape master} branch of each repo. This is because the master branches of the three repos are the stable ones, and compatible with one another. If you want specific versions, you can just checkout the tag you want. If you do so, make sure you checkout the same tag for all three repos.\hypertarget{md_pages_getstarted_build_and_install_autotoc_md24}{}\doxysubsection{3. Install Dependencies}\label{md_pages_getstarted_build_and_install_autotoc_md24}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md25}{}\doxysubsection{4. Build pressio4py}\label{md_pages_getstarted_build_and_install_autotoc_md25}
...
This should create the Python library inside {\ttfamily \$\{W\+O\+R\+K\+D\+IR\}/pressio4py-\/install} which you can import in Python.\hypertarget{md_pages_getstarted_build_and_install_autotoc_md26}{}\doxysubsection{5. Running the tests or demos}\label{md_pages_getstarted_build_and_install_autotoc_md26}
