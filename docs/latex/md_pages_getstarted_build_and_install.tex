...
\end{DoxyParagraph}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md44}{}\doxysection{Prerequisites}\label{md_pages_getstarted_build_and_install_autotoc_md44}
...
\end{DoxyItemize}\hypertarget{md_pages_getstarted_build_and_install_autotoc_md45}{}\doxysection{Pratical steps}\label{md_pages_getstarted_build_and_install_autotoc_md45}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md46}{}\doxysubsection{1. Prep}\label{md_pages_getstarted_build_and_install_autotoc_md46}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md47}{}\doxysubsection{2. Cloning}\label{md_pages_getstarted_build_and_install_autotoc_md47}
...
By default, the above commands will clone the {\itshape master} branch of each repo. This is because the master branches of the three repos are the stable ones, and compatible with one another. If you want specific versions, you can just checkout the tag you want. If you do so, make sure you checkout the same tag for all three repos.\hypertarget{md_pages_getstarted_build_and_install_autotoc_md48}{}\doxysubsection{3. Install Dependencies}\label{md_pages_getstarted_build_and_install_autotoc_md48}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_and_install_autotoc_md49}{}\doxysubsection{4. Build pressio4py}\label{md_pages_getstarted_build_and_install_autotoc_md49}
...
This should create the Python library inside {\ttfamily \$\{W\+O\+R\+K\+D\+IR\}/pressio4py-\/install} which you can import in Python.\hypertarget{md_pages_getstarted_build_and_install_autotoc_md50}{}\doxysubsection{5. Running the tests or demos}\label{md_pages_getstarted_build_and_install_autotoc_md50}
