...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo5_autotoc_md134}{}\doxysection{Overview}\label{md_pages_demos_demo5_autotoc_md134}
This is a follow up to the previous demo \href{./md_pages_demos_demo4.html}{\texttt{ here}} We compare here maskdd Galerkin and masked LSPG.\hypertarget{md_pages_demos_demo5_autotoc_md135}{}\doxysection{Main function}\label{md_pages_demos_demo5_autotoc_md135}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md136}{}\doxysubsection{1. Run FOM and collect snapshots}\label{md_pages_demos_demo5_autotoc_md136}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md137}{}\doxysubsection{2. Compute POD modes}\label{md_pages_demos_demo5_autotoc_md137}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md138}{}\doxysubsection{3. Create the sampling indices}\label{md_pages_demos_demo5_autotoc_md138}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md139}{}\doxysubsection{4. The masker class}\label{md_pages_demos_demo5_autotoc_md139}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md140}{}\doxysubsection{5. Masked Galerkin ROM}\label{md_pages_demos_demo5_autotoc_md140}
...
\DoxyCodeLine{  nlsO = solvers.create\_newton\_raphson(stepper, romState, lsO)}
\DoxyCodeLine{  nlsO.setMaxIterations(15)}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{\# solve the problem}}
\DoxyCodeLine{  ode.advance\_n\_steps(stepper, romState, 0., dt, nsteps, nlsO)}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md141}{}\doxysubsection{6. Masked LSPG ROM}\label{md_pages_demos_demo5_autotoc_md141}
...
\DoxyCodeLine{  \textcolor{comment}{\# linear and non linear solver}}
\DoxyCodeLine{  lsO = MyLinSolver()}
\DoxyCodeLine{  nlsO = solvers.create\_gauss\_newton(stepper, romState, lsO)}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo5_autotoc_md142}{}\doxysection{Results}\label{md_pages_demos_demo5_autotoc_md142}
