...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{\# to select rows there are various methods wee.g. one can use random or some other way}}
\DoxyCodeLine{collocationIndices = np.array([2,3,10,56])}
\end{DoxyCode}
