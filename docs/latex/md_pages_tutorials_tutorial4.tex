...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial4_autotoc_md83}{}\doxysection{What is a masked Galerkin problem?}\label{md_pages_tutorials_tutorial4_autotoc_md83}
...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial4_autotoc_md84}{}\doxysection{Masked Galerkin with collocation}\label{md_pages_tutorials_tutorial4_autotoc_md84}
...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial4_autotoc_md85}{}\doxysection{How to create a masked Galerkin problem?}\label{md_pages_tutorials_tutorial4_autotoc_md85}
...
Note that as in the default case, the time-\/stepping scheme is part of the class name.\hypertarget{md_pages_tutorials_tutorial4_autotoc_md86}{}\doxysection{How to solve a masked Galerkin problem?}\label{md_pages_tutorials_tutorial4_autotoc_md86}
Solving the masked problem can be done using the same A\+PI for solving a default problem, see \href{./md_pages_tutorials_tutorial3.html}{\texttt{ this}}.\hypertarget{md_pages_tutorials_tutorial4_autotoc_md87}{}\doxysection{Want to see all the above pieces in action?}\label{md_pages_tutorials_tutorial4_autotoc_md87}
