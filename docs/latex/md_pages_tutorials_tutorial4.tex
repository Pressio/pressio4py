...
Note that as in the default case, the time-\/stepping scheme is part of the class name.\hypertarget{md_pages_tutorials_tutorial4_autotoc_md78}{}\doxysection{How to solve a default Galerkin problem?}\label{md_pages_tutorials_tutorial4_autotoc_md78}
