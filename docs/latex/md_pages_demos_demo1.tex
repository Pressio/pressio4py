...
This page describes a demo for a reproductive Galerkin R\+OM applied to a 1D advection-\/diffusion problem using P\+OD modes as basis. By the end, it should be clear how to setup the problem and the various steps involved.~\newline
 To jump directly at the full demo script, click \href{https://github.com/Pressio/pressio4py/blob/master/demos/unsteady_default_galerkin_advdiff1d_pod/main.py}{\texttt{ here.}}
\end{DoxyParagraph}
...
Here we list the functions performing the various stages of the run.\hypertarget{md_pages_demos_demo1_autotoc_md6}{}\doxysubsubsection{1. Run F\+O\+M and collect snapshots}\label{md_pages_demos_demo1_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo1_autotoc_md7}{}\doxysubsubsection{2. Compute P\+O\+D modes}\label{md_pages_demos_demo1_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo1_autotoc_md8}{}\doxysubsubsection{3. Construct and run Galerkin}\label{md_pages_demos_demo1_autotoc_md8}
