...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo1_autotoc_md4}{}\doxysection{Code for the various stages in main}\label{md_pages_demos_demo1_autotoc_md4}
Here we list the functions performing the various stages of the run.\hypertarget{md_pages_demos_demo1_autotoc_md5}{}\doxysubsection{1. Run F\+O\+M and collect snapshots}\label{md_pages_demos_demo1_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo1_autotoc_md6}{}\doxysubsection{2. Compute P\+O\+D modes}\label{md_pages_demos_demo1_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo1_autotoc_md7}{}\doxysubsection{3. Construct and run Galerkin}\label{md_pages_demos_demo1_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo1_autotoc_md8}{}\doxysection{Results}\label{md_pages_demos_demo1_autotoc_md8}
If everything works fine, the following plot shows the result. We see that for this toy example, the full solution is recovered very well with Galerkin with just five P\+OD modes.  