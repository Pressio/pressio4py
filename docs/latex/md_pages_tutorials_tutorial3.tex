...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial3_autotoc_md76}{}\doxysection{What is a default Galerkin problem?}\label{md_pages_tutorials_tutorial3_autotoc_md76}
...
\end{DoxyParagraph}
where $\hat{y}$ is the reduced state, also called generalized coordinates, $y$ is the full-\/order model (F\+OM) state, $y_{ref}$ is a reference F\+OM state, $\phi$ is the orthonormal basis, and $f(...)$ is the F\+OM velocity. Schematically, this system corresponds to the figure below. \hypertarget{md_pages_tutorials_tutorial3_autotoc_md77}{}\doxysection{How to create a default Galerkin problem?}\label{md_pages_tutorials_tutorial3_autotoc_md77}
...
\end{DoxyCode}
\hypertarget{md_pages_tutorials_tutorial3_autotoc_md78}{}\doxysection{How to solve a default Galerkin problem?}\label{md_pages_tutorials_tutorial3_autotoc_md78}
...
Note that we are working on enriching the A\+PI to integrate in time. For example, we will soon support function class to advance the problem until a condition is met, or until a target time is reached.\hypertarget{md_pages_tutorials_tutorial3_autotoc_md79}{}\doxysection{Want to see all the above pieces in action?}\label{md_pages_tutorials_tutorial3_autotoc_md79}
Look at \href{./md_pages_demos_demo1.html}{\texttt{ this demo}} that uses default Galerkin for a 1d P\+DE.\hypertarget{md_pages_tutorials_tutorial3_autotoc_md80}{}\doxysection{Some considerations}\label{md_pages_tutorials_tutorial3_autotoc_md80}
