...
Once the problem object is created, one needs to integrate in time the reduced system. This can be done as follows\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{rom.galerkin.advanceNSteps(problem, yRom, t0, dt, Nsteps [, observer])}
\end{DoxyCode}
