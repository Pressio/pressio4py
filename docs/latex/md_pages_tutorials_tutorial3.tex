...
Note that we are working on enriching the A\+PI to integrate in time. For example, we will soon support function class to advance the problem until a condition is met, or until a target time is reached.\hypertarget{md_pages_tutorials_tutorial3_autotoc_md72}{}\doxysection{Want to see all the above pieces in action?}\label{md_pages_tutorials_tutorial3_autotoc_md72}
