...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial2_autotoc_md74}{}\doxysection{Context}\label{md_pages_tutorials_tutorial2_autotoc_md74}
...
This allows one to use an arbitrary function to map the R\+OM state to the F\+OM state.\hypertarget{md_pages_tutorials_tutorial2_autotoc_md75}{}\doxysection{Code}\label{md_pages_tutorials_tutorial2_autotoc_md75}
