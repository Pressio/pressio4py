...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial2_autotoc_md64}{}\doxysection{Context}\label{md_pages_tutorials_tutorial2_autotoc_md64}
...
This allows one to use an arbitrary function to map the R\+OM state to the F\+OM state.\hypertarget{md_pages_tutorials_tutorial2_autotoc_md65}{}\doxysection{Code}\label{md_pages_tutorials_tutorial2_autotoc_md65}
