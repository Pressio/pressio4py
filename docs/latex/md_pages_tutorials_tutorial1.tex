...
Note that the above expressions are abtract, since they do not specify what kind of data structure is used for $y_{fom}$. Therefore, pressio4py supports two scenarios, namely the state is an rank-\/1 tensor (i.\+e., vector) or a rank-\/2 tensor.\hypertarget{md_pages_tutorials_tutorial1_autotoc_md62}{}\doxysection{Rank-\/1 state}\label{md_pages_tutorials_tutorial1_autotoc_md62}
