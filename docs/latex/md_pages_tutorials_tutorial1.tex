...
\DoxyCodeLine{\textcolor{stringliteral}{  In the ROM context, a linear decoder (or mapping) represents}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{        y\_fom = phi * y\_rom}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
...
\DoxyCodeLine{\textcolor{stringliteral}{  where "{}y\_rom"{} is referred to as the generalized coordinates (or latent space)}}
\DoxyCodeLine{\textcolor{stringliteral}{  and "{}y\_fom"{} represents an approximation of the FOM state.}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
