...
\begin{DoxyParagraph}{}
This tutorial shows how to create a linear decoder/mapping in pressio4py.
\end{DoxyParagraph}
...
A linear decoder in pressio4py represents this linear mapping. Note that we have not specified what kind of data structure is used for $y_{fom}$.\hypertarget{md_pages_tutorials_tutorial1_autotoc_md63}{}\doxysection{Rank-\/1 state}\label{md_pages_tutorials_tutorial1_autotoc_md63}
