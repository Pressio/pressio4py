...
Note that the above expressions are abtract, since they do not specify what kind of data structure is used for $y_{fom}$. pressio4py supports the following scenarios\+:
\begin{DoxyItemize}
