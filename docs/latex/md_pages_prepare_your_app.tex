...
\end{DoxyParagraph}
\hypertarget{md_pages_prepare_your_app_autotoc_md65}{}\doxysection{Is pressio4py applicable to your problem and application?}\label{md_pages_prepare_your_app_autotoc_md65}
...
\end{DoxyParagraph}
\hypertarget{md_pages_prepare_your_app_autotoc_md66}{}\doxysection{What glue code do you need on your end to use pressio4py?}\label{md_pages_prepare_your_app_autotoc_md66}
...
\end{DoxyParagraph}
\hypertarget{md_pages_prepare_your_app_autotoc_md67}{}\doxysection{Where is the adapter used?}\label{md_pages_prepare_your_app_autotoc_md67}
