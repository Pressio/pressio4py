...
\end{DoxyParagraph}
\hypertarget{md_pages_prepare_your_app_autotoc_md67}{}\doxysection{What glue code do you need on your end to use pressio4py?}\label{md_pages_prepare_your_app_autotoc_md67}
pressio4py requires your application to expose the \char`\"{}velocity\char`\"{} $\boldsymbol{f}(\boldsymbol{y},t; \boldsymbol{\mu})$ and (optionally) the action of the Jacobian matrix $\partial f/\partial y$. This design choice pivots on the generality of the formulation above. We remark that the {\itshape same} expressive model/\+A\+PI is being used/expected by other well-\/established Python libraries, e.\+g., {\ttfamily scipy.\+ode}.
...
\DoxyCodeLine{    A[:,:] = \textcolor{comment}{\# compute df/dy * B}}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{\# create result of df/dy*B, B is typically a skinny dense matrix}}
...
\end{DoxyParagraph}
\hypertarget{md_pages_prepare_your_app_autotoc_md68}{}\doxysection{Where is the adapter used?}\label{md_pages_prepare_your_app_autotoc_md68}
