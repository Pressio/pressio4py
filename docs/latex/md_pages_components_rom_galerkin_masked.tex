...
Import as\+: \quad{} \quad{} \quad{} {\ttfamily from pressio4py.\+rom import galerkin} \hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md72}{}\doxysection{API, Parameters and Requirements}\label{md_pages_components_rom_galerkin_masked_autotoc_md72}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md73}{}\doxysubsection{Masker}\label{md_pages_components_rom_galerkin_masked_autotoc_md73}
...
where {\ttfamily sample\+\_\+indices} is a {\ttfamily numpy.\+array} holding the set of the row indices to sample.\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md74}{}\doxysection{Example usage}\label{md_pages_components_rom_galerkin_masked_autotoc_md74}
todo link tutorials 