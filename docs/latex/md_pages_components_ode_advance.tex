...
\DoxyCodeLine{                time\_step\_size, num\_steps);                         (1)}
\DoxyCodeLine{}
\DoxyCodeLine{advance\_n\_steps(stepper, state, start\_time, \(\backslash\)}
\DoxyCodeLine{                time\_step\_setter, num\_steps);                       (2)}
\DoxyCodeLine{}
\DoxyCodeLine{advance\_n\_steps\_and\_observe(stepper, state, start\_time, \(\backslash\)}
\DoxyCodeLine{                            time\_step\_size, num\_steps, observer);   (3)}
\DoxyCodeLine{}
\DoxyCodeLine{advance\_n\_steps\_and\_observe(stepper, state, start\_time, \(\backslash\)}
\DoxyCodeLine{                            time\_step\_setter, num\_steps, observer); (4)}
