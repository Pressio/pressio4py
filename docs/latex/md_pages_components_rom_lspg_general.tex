...
The pressio4py unsteady LSPG ROMs are designed such that using them involves three main steps\+:\hypertarget{md_pages_components_rom_lspg_general_autotoc_md84}{}\doxysection{1. Create}\label{md_pages_components_rom_lspg_general_autotoc_md84}
You create an instance of a \char`\"{}\+LSPG problem\char`\"{}, e.\+g.\+: ~\newline



\begin{DoxyCode}{0}
\DoxyCodeLine{problem = pressio4py.rom.lspg.unsteady.DefaultExplicitProblem(args)}
