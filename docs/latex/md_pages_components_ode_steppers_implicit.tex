...
Here, $y$ is the state, $f$ the velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md36}{}\doxysection{API, Parameters and Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md36}
