...
Import as\+: \quad{} \quad{} \quad{} {\ttfamily from pressio4py import ode} \hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md35}{}\doxysection{Overview}\label{md_pages_components_ode_steppers_implicit_autotoc_md35}
...
Here, $y$ is the state, $f$ the velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md36}{}\doxysection{Continuous-\/time API, Parameters and Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md36}
...
\begin{DoxyItemize}
\item {\ttfamily scheme}\+: enum value to set the desired stepping scheme.~\newline
...
\item {\ttfamily system}\+: object defining how to create an instance of the velocity $f$ and how to compute it.~\newline
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md38}{}\doxysubsection{What to do after a stepper is created?}\label{md_pages_components_ode_steppers_implicit_autotoc_md38}
