...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md117}{}\doxysection{Overview}\label{md_pages_demos_demo3_autotoc_md117}
This demo solves the same problem as the one \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo1.html}{\texttt{ here}}, but instead of using POD modes, we show here how to use a nonlinear manifold computed via kernel PCA.\hypertarget{md_pages_demos_demo3_autotoc_md118}{}\doxysection{Main function}\label{md_pages_demos_demo3_autotoc_md118}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md119}{}\doxysubsection{1. Run FOM and collect snapshots}\label{md_pages_demos_demo3_autotoc_md119}
This step is the same as described \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo1.html}{\texttt{ here}},\hypertarget{md_pages_demos_demo3_autotoc_md120}{}\doxysubsection{2. Setup and train the nonlinear k\+PCA mapper}\label{md_pages_demos_demo3_autotoc_md120}
...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md121}{}\doxysubsection{3. Construct and run LSPG}\label{md_pages_demos_demo3_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md122}{}\doxysection{Results}\label{md_pages_demos_demo3_autotoc_md122}
