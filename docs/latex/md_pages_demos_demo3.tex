...
This page describes a demo for a reproductive L\+S\+PG R\+OM applied to a 1D advection-\/diffusion problem using a nonlinear manifold via kernel P\+CA. This demo purposefully focuses on a simple test since the main goal is to demonstrate the steps and the code. More complex cases will be added later. To jump directly at the full demo script, click \href{https://github.com/Pressio/pressio4py/blob/master/demos/unsteady_default_lspg_advdiff1d_kpca/main.py}{\texttt{ here.}}
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md18}{}\doxysection{Overview}\label{md_pages_demos_demo3_autotoc_md18}
This demo solves the same problem as the one \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo2.html}{\texttt{ here}}, but instead of using P\+OD modes, we show here how to use a nonlinear manifold computed via kernel P\+CA.\hypertarget{md_pages_demos_demo3_autotoc_md19}{}\doxysection{Imports}\label{md_pages_demos_demo3_autotoc_md19}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md20}{}\doxysection{Main function}\label{md_pages_demos_demo3_autotoc_md20}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md21}{}\doxysection{Code for the various stages in main}\label{md_pages_demos_demo3_autotoc_md21}
Here we list the functions performing the various stages of the run.\hypertarget{md_pages_demos_demo3_autotoc_md22}{}\doxysubsection{1. Run F\+O\+M and collect snapshots}\label{md_pages_demos_demo3_autotoc_md22}
This step is the same as described \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo2.html}{\texttt{ here}},\hypertarget{md_pages_demos_demo3_autotoc_md23}{}\doxysubsection{2. Setup and train the nonlinear k\+P\+C\+A mapper}\label{md_pages_demos_demo3_autotoc_md23}
...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md24}{}\doxysubsection{3. Construct and run L\+S\+PG}\label{md_pages_demos_demo3_autotoc_md24}
