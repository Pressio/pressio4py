...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md16}{}\doxysection{Overview}\label{md_pages_demos_demo3_autotoc_md16}
This demo solves the same problem as the one \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo1.html}{\texttt{ here}}, but instead of using P\+OD modes, we show here how to use a nonlinear manifold computed via kernel P\+CA.\hypertarget{md_pages_demos_demo3_autotoc_md17}{}\doxysection{Main function}\label{md_pages_demos_demo3_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md18}{}\doxysubsection{1. Run F\+O\+M and collect snapshots}\label{md_pages_demos_demo3_autotoc_md18}
This step is the same as described \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo1.html}{\texttt{ here}},\hypertarget{md_pages_demos_demo3_autotoc_md19}{}\doxysubsection{2. Setup and train the nonlinear k\+P\+C\+A mapper}\label{md_pages_demos_demo3_autotoc_md19}
...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md20}{}\doxysubsection{3. Construct and run L\+S\+PG}\label{md_pages_demos_demo3_autotoc_md20}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md21}{}\doxysection{Results}\label{md_pages_demos_demo3_autotoc_md21}
