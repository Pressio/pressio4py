...
This demo solves the same problem as the one \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo1.html}{\texttt{ here}}, but instead of using P\+OD modes, we show here how to use a nonlinear manifold computed via kernel P\+CA.\hypertarget{md_pages_demos_demo3_autotoc_md19}{}\doxysection{Main function}\label{md_pages_demos_demo3_autotoc_md19}
...
\DoxyCodeLine{  \textcolor{comment}{\# see actual demo for plotting}}
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md20}{}\doxysection{Code for the various stages in main}\label{md_pages_demos_demo3_autotoc_md20}
Here we list the functions performing the various stages of the run.\hypertarget{md_pages_demos_demo3_autotoc_md21}{}\doxysubsection{1. Run F\+O\+M and collect snapshots}\label{md_pages_demos_demo3_autotoc_md21}
This step is the same as described \href{https://pressio.github.io/pressio4py/html/md_pages_demos_demo1.html}{\texttt{ here}},\hypertarget{md_pages_demos_demo3_autotoc_md22}{}\doxysubsection{2. Setup and train the nonlinear k\+P\+C\+A mapper}\label{md_pages_demos_demo3_autotoc_md22}
...
\end{DoxyParagraph}
\hypertarget{md_pages_demos_demo3_autotoc_md23}{}\doxysubsection{3. Construct and run L\+S\+PG}\label{md_pages_demos_demo3_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{md_pages_demos_demo3_autotoc_md24}{}\doxysection{Results}\label{md_pages_demos_demo3_autotoc_md24}
